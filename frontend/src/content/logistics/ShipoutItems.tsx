                                ...
                                {shipoutItemList.map((list, index) => (
                                    <React.Fragment key={list.index_id || index}>
                                        ...
                                        >
                                            ...
                                            <td className="py-2 px-2 text-gray-400 text-left text-custom-sm">
                                                <div className="flex items-center space-x-3">
                                                    <div>
                                                        ...
                                                        <div className="group flex items-center">
                                                            <p className="text-gray-400 text-custom-sm">{highlightMatch(lang === "en" ? list.account_name_en : list.account_name_cn, searchTerm)}</p>
                                            ...
                                            <td className="py-2 px-2 text-gray-400 text-left text-custom-sm">
                                                <div className="group flex items-center">
                                                    <p className="text-gray-400 text-custom-sm">{list.invoice_no ? highlightMatch(list.invoice_no, searchTerm) : translations["N.A."] || "N.A."}</p>
                                            ...
                                            <td className="py-2 px-2 text-gray-400 text-left text-custom-sm">
                                                <input
                                                    ...
                                                    onChange={(e) => {
                                                        const value = e.target.value;
                                                        if (/^\d*\.?\d*$/.test(value)) {
                                                            setShipoutItem((prev) => prev.map((item) => (item.index_id === list.index_id ? { ...item, shipped_packages: Number(value) } : item)));
                                                        }
                                                    }}
                                                    onFocus={(e) => {
                                                        if (e.target.value === "0") {
                                                ...
                                                <td colSpan={10} className="py-2 px-2">
                                                    <table className="w-full" style={{ backgroundColor: "#060818" }}>
                                                        <thead className="sticky top-0 z-[1] py-1 px-2" style={{ backgroundColor: "#1f2132" }}>
                                                            <tr className="border-b" style={{ borderColor: "#2d2d30" }}>
                                                                <th className="w-auto text-left py-2 px-2 text-gray-400 text-sm w-12 border border-[#40404042]">{translations["Product Code"]}</th>
                                                                <th className="w-auto text-left py-2 px-2 text-gray-400 text-sm w-12 border border-[#40404042]">{translations["Product Name"]}</th>
